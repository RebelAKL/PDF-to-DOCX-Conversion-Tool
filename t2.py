...
def match_page_size(docx_file):
    ...
    for section in doc.sections:
        section.page_width = Inches(8.5)  # Typical letter size width
        section.page_height = Inches(11)  # Typical letter size height
...
def apply_fixed_width_font(docx_file):
    ...
    for paragraph in doc.paragraphs:
        for run in paragraph.runs:
            run.font.name = "Courier New"  # Set font to Courier New
